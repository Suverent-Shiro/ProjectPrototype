# Project: Prototype
Project: Prototype is a Minecraft server template schematic. It contains pre-configured plugin configurations for faster Minecraft server configuration.
*This repository is primarily in Polish*

<!----------------------------------------------------------------------------->
## Oficjalne repozytorium Project: Prototype! 
...
<ins>Rekomendowane jest użycie najnowszej stabilnej wersji Project: Prototype</ins> *Rozwiń po listę pluginów, ich wersji a także preferowanej wersji Minecrafta.*
<details>
  <summary><b>Najnowsza stabilna wersja Project: Prototype / 3.1</b></summary>

- Kompatyblina wersja Minecraft: **1.21.1**
- Rekomendowany silnik: **Purpur 2329**
- Zawarte pluginy w wersji **3.1**
...
<details>
  <summary><b>Najnowsza wersja Project: Prototype / 3.1</b></summary>
